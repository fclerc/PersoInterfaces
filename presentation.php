...
<html>
    ...
    <body>
        <div class="container presentation">
            ...
            <p>A chaque nouvelle séquence du MOOC (dans la plupart des MOOCs, 1 séquence = 1 semaine), l'équipe définira si elle le souhaite une nouvelle stratégie pédagogique, et un nouveau contexte de séquence. Cependant, une grande liberté est laissée à ce niveau-là : il est  par exemple tout à fait possible de conserver la même stratégie pédagogique tout au long du MOOC, et ne faire varier que le contexte de séquence.</p>
