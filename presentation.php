...
<html>
    ...
    <body>
        <div class="container presentation">
            ...
            La deuxième interface, qui est l'interface principale pour l'enseignant, est celle qui va lui permettre l'édition de sa stratégie pédagogique pour chaque séquence du MOOC. Elle est décomposée en trois parties principales :</p>
            <ul>
            ...
            <p>Enfin, deux interfaces (qui exploitent en fait exactement le même code que la page de définition du contexte de séquence), vont permettre à l'enseignant de définir des profils et contexte 'live' qu'il pourra à terme utiliser pour tester sa stratégie pédagogique.</p>
            
            <p>Vous remarquerez une 5ème interface, concernant la définition des ressources, qui permettra à terme de définir les ressources et de renseigner leurs attributs...mais pour plus de facilité et de compréhension pour l'enseignant elle a besoin d'être un peu remaniée.</p>
            
            <p>Sur toutes les interfaces, la documentation disponible dans les modèles définis est affichée à l'enseignant (ce sont les petites icônes <span class="glyphicon glyphicon-info-sign"></span> - cliquer pour avoir la documentation, survoler pour avoir l'échelle uniquement). Les valeurs admises par les paramètres et indicateurs sont également affichées ainsi que, dans le cas des paramètres d'activités, la liste des valeurs que l'enseignant a effectivement utilisées lorsqu'il a défini les ressources (cela lui permet par exemple de disposer de la liste de toutes les ressources). De plus, tous ces éléments sont cliquables lorsque l'enseignant doit remplir un formulaire dans la règle en cours de définition (le formulaire des directement rempli avec la valeur souhaitée).</p>
            ...
            <ul>
                <li>En cours de développement actuellement : le module qui permettra, à partir des données sur les apprenants et celles définies par l'enseignant, de générer la boussole.</li>
                <li>Une fois ce module implémenté, permettre à l'enseignant de réaliser des tests, à partir de profils et contextes dont il aura lui-même  défini le contenu.</li>
                <li>L'ajout de contraintes lorsque l'enseignant utilise les formulaires et définit des règles afin de minimiser les risques d'erreur.</li>
                <li>Une documentation plus avancée, à la fois pour les concepteurs de plateformes de MOOCs et les enseignants</li>
            ...
            <ul>
                ...
                <li>Actuellement, lorsqu'il définit sa stratégie pédagogique, l'enseignant n'a pas vraiment d'aide extérieure, il n'a pas de donnée concernant les activités réelles du MOOC. On pourrait donc lui proposer un tableau de bord lui fournissant des informations sur le comportement global des apprenants (comme par exemple la  moyenne, pour chaque indicateur du profil, de toutes les valeurs prises par les apprenants). De manière plus complexe, une idée que nous avons également est d'exploiter les traces laissées par tous les apprenants afin de détecter les éventuelles difficultés qu'ils rencontrent, et les faire remonter aux enseignants ou trouver une solution de manière dynamique.</li>
